...
namespace MeepleBoard.Infra.Data.Migrations
{
    ...
    [Migration("20260823134606_IncreaseGameSearchCatalogNameLength")]
    partial class IncreaseGameSearchCatalogNameLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Friendship", b =>
                {
                    ...
                    b.ToTable("Friendships", t =>
                        {
                            t.HasCheckConstraint("CK_Friendship_UserA_Not_UserB", "[UserAId] <> [UserBId]");
                        });
                });
            ...
            modelBuilder.Entity("MeepleBoard.Domain.Entities.GameSearchCatalog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("IsExpansion", "NormalizedName");

                    b.ToTable("GameSearchCatalog", (string)null);
                });

            modelBuilder.Entity("MeepleBoard.Domain.Entities.GameSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MeepleBoard.Domain.Entities.GameSessionPlayer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MeepleBoard.Domain.Entities.GameSession", b =>
                {
                    b.HasOne("MeepleBoard.Domain.Entities.User", "Organizer")
                        .WithMany()
            ...
            modelBuilder.Entity("MeepleBoard.Domain.Entities.GameSessionPlayer", b =>
                {
                    b.HasOne("MeepleBoard.Domain.Entities.GameSession", "Session")
                        .WithMany("Players")
